...
//
//        if(needed_path[0] == -1) {
//            strcpy(Settings.savepath, "mc0:/PVCS/");
//        }
//        else {
...
//    sprintf(CNF_p,
//        "# SKIN.CNF == Skin configuration file for the emulator PVCS    \r\n"
...
//        printf("Savepath: %s\n", Settings.savepath);
    ...
    if(CNF_p == NULL) return;
    sprintf(CNF_p,
        "# PVCS.CNF == Configuration file for the emulator PVCS        \r\n"
        "# CNF Handling Code (c)2006 Ronald Andersson aka dlanor       \r\n"
        "# ------------------------------------------------------------\r\n"
        "OffsetX     = %d\r\n"
        "OffsetY     = %d\r\n"
...
void Default_Skin_CNF(void)
{
    ...
    strcpy(FCEUSkin.bgTexture,"");
    strcpy(FCEUSkin.bgMenu,"");
}
